    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-4 bg-neutral-50 dark:bg-neutral-950">
      <div className="w-full max-w-sm bg-white dark:bg-neutral-900 p-8 rounded-2xl shadow-xl shadow-neutral-200/50 dark:shadow-none border border-neutral-100 dark:border-neutral-800">
        <div className="mb-8 text-center">
            <h1 className="text-2xl font-light tracking-tight text-neutral-900 dark:text-white">Join Mini Habits</h1>
            <p className="text-neutral-400 dark:text-neutral-500 text-sm mt-2">Start your journey today</p>
        </div>

        <form action={dispatch} className="space-y-4">
          <div>
            <label className="block text-xs font-medium text-neutral-700 dark:text-neutral-300 mb-1" htmlFor="name">
              Name (Optional)
            </label>
            <input
          ...
          <div className="pt-2">
            ...
            >
                {isPending ? <Loader2 className="animate-spin w-4 h-4" /> : <>Create Account <ArrowRight className="w-4 h-4" /></>}
            </button>
          </div>
        ...
        <div className="mt-6 text-center text-xs text-neutral-400">
            ...
            <Link href="/login" className="text-neutral-900 dark:text-neutral-200 font-medium hover:underline">
                Sign in
            </Link>
        </div>
      </div>
